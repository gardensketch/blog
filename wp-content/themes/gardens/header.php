...
<script>
  ...
  ga('create', 'UA-51808543-1', 'gardensketchapp.com');
  ga('send', 'pageview');
        ...
        <?php/*
          ...
          if ($primaryNav == '') { ?>
            <ul class="<?php echo esc_attr( $menuClass ); ?>">
                <li <?php if (is_home()) echo('class="current_page_item"') ?>><a href="<?php echo esc_url( home_url( '/' ) ); ?>"><?php esc_html_e('Blog','Flexible') ?></a></li>
